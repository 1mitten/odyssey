...
|---|---|---|---|
| `prisoner-brief.md` | 2026-09-26 | **brief, unanswered** | The prompt for Claude Design for the prisoner interface: the bed's purpose control, the prisoner's pane (mode, willingness, escape risk and their reasons), the capture menu, Arrest, the cell on the board and the jumpsuit colour. Decisions in `docs/design/59-prisoners.md` |
