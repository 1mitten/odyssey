...
| Carrying up a ladder | A hauler cannot climb one at all. Stairs (`U44`) are the unit that opens it — and until U44 this was true of stockpile hauling only, because construction delivery never asked for the hauling mode (`28-stairs.md` §3) |
