...
3. **Do rooms span layers?** No — a room is a flood fill within one layer. A stairwell connects two rooms rather than merging them, and heat flows between them through the opening. Heat rises as a flow, not as a shared volume.
...
6. **Zones and stockpiles.** Per layer or 3D volumes — see `a-14-bills-stockpiles-inventory.md`; the decision lands in `05-ai-and-jobs.md`.
