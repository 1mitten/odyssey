...
Names that are not interface keys: people, places, factions, creatures, the calendar. The brief requires every one of these to be ours, so this page exists to make the empty rows visible.

| Category | Name | Status | Notes |
|---|---|---|---|
| The world | **Carrow** | proposed  | A city-world: one settlement that grew until it covered the planet. Short, bleak, easy to say, and it survives being said a thousand times. The register throughout is English industrial rather than classical or invented-exotic: a working future, not a mythic one |
| The city | **Ashgate** | proposed  | The district the prototype is set in. Formally Ashgate Division, colloquially the Gate. Ash for what happened to it, gate because a division boundary is a gate. The official-versus-colloquial split is deliberate and reusable: old civic signage says one thing, colonists say another |
| What you build | **Holding** | proposed  | The noun for a player settlement. You hold a claim on a block. Gives 'your holding', 'a neighbouring holding', and a default colony name of Ashgate Holding |
| Your people | **Reclaimers** | proposed  | What your colonists call themselves. Reclaiming is the whole economy: you are not miners or settlers, you take a dead city apart and live in it. A little proud, which is right for people who chose this |
...
| Storyteller | **Jacob** | accepted  | A llama who keeps the calendar: the rhythm storyteller, threats on a cycle you can learn, slowly rising. The default. Owner, 2026-09-26 (design 68). Jacob left the colonist name pool the same day for Jonah, in place |
| Storyteller | **Trent** | accepted  | Half man, half salvage, his implants misfiring at random: the chaotic storyteller, anything any time, never quiet for too long. Owner, 2026-09-26 (design 68). Trent left the colonist name pool the same day for Wade, in place |
| Storyteller | **Kano** | accepted  | A vast, sleepy pig: the calm storyteller, long quiet seasons and then one hard test. Owner, 2026-09-26 (design 68) |
| Storyteller | **Registrar Vell** | superseded  | Superseded 2026-09-26 by the owner's Jacob, Trent and Kano (design 68). Steady escalation. Framed as the old civic apparatus still running: a registrar who expects your holding to follow a curve and files it accordingly. The default |
| Storyteller | **Warden Ida** | superseded  | Superseded 2026-09-26 by the owner's Jacob, Trent and Kano (design 68). Long quiet stretches, gentler peaks. For building and looking at what you built |
| Storyteller | **the Static** | superseded  | Superseded 2026-09-26 by the owner's Jacob, Trent and Kano (design 68). No curve at all. A broadcast that never stopped, saying whatever it says. For players who want the story to surprise them rather than escalate |
| Storyteller | **Inspector Crane** | superseded  | Superseded 2026-09-26 by the owner's Jacob, Trent and Kano (design 68). Front-loaded and harsh. Arrives early, does not wait for you to be ready. The hard mode |
...
| Month | **Bramble** | proposed  | First month of Glare |
...
**0 of 35 rows have no name at all.** Those are not oversights to tidy up later: a storyteller and a faction with no name cannot be written about, and the city the whole prototype is set in is currently called nothing.
