...
|---|---|---|---|---|
| **Knife** | `ui.item.knife` | Close work, and butchery | sheet 05 (tools and weapons), high | M3 |
| **Blade** | `ui.item.sword` | Reach and damage in melee | sheet 05 (tools and weapons), high | M3 |
| **Club** | `ui.item.club` | Blunt. Downs rather than kills | sheet 05 (tools and weapons), high | M3 |
| **Spear** | `ui.item.spear` | Cheap reach | sheet 03 (camp and crafting), high | M3 |
| **Pickaxe** | `ui.item.pickaxe` | Mining tool. A weapon in a pinch | sheet 05 (tools and weapons), high | M3 |
| **Shovel** | `ui.item.shovel` | Rubble and soil | sheet 05 (tools and weapons), high | M3 |
...
| **Boots** | `ui.item.boots` | Pace and protection <br>**Needs:** a pair of boots | no art | M3 |
| **Pack** | `ui.item.pack` | Carry more on a caravan | sheet 08 (salvage gear), high | M3 |
| **Torch** | `ui.item.flashlight` | Portable light | sheet 08 (salvage gear), high | M3 |
| **Radio** | `ui.item.radio` | Talk at distance | sheet 08 (salvage gear), high | M3 |
| **Compass** | `ui.item.compass` | Travel without getting lost | sheet 08 (salvage gear), high | M3 |
