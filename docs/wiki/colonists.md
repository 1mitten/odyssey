...
| **Prospecting** | `ui.status.prospecting` | Tapping an exposed rock face to learn what the rock round it holds <br>**Needs:** a hand lens held to a rock face | no art | DM |
