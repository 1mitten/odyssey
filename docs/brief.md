...
| Setting | **A sci-fi city-world.** Prototype map type: **ruined city** — pre-placed multi-storey shells to occupy, streets to dig beneath, salvage instead of ore veins. Later map types: outskirts/frontier (needs nature packs), living district (needs city-population AI — far future). |
