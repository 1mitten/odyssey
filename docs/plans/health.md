...
`docs/research/health-interview.md` (four answers). **Nothing is built and nothing is approved
to build**: the owner chose documents first. H1 starts when the plan is approved; H5 starts
when the mockups are back from Claude Design (`docs/reference/mockups/health-tab-brief.md`).
...
- **The plan's approval** to start H1.
- **The mockups** from Claude Design for H5, and the height decision if the returned tab needs
  more than 157 px.
