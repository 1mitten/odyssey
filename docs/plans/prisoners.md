...
- **Design:** `docs/design/58-prisoners.md`.
...
|---|---|---|---|
| **P0** | Research a-20, the interview, design 58, this plan | docs only | — |
...
| **P7** | **Feeding.** `FeedPrisoner`. Food in a cell is **not hauled out and not eaten by colonists** (design 58 §14) | fast + Long | Wardens bring meals |
...
- `AllegianceConsumerTests`: one assertion per row of design 58 §4b's table.
...
- The gain table of design 58 §8 reproduced exactly.
...
- The confirmation of every proposed number in design 58 §8–§10.
