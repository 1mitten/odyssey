...
| CB | Blood: spurts, a mark per hit, pools under the fallen, a fade by the tick (design 33 §10) | **▶ playtest** | **none** — presentation only | **built 2026-09-24, `claude/combat-blood`** |
