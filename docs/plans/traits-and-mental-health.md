...
`docs/research/traits-interview.md`; design `docs/design/51-traits-and-mental-health.md`, whose
...
Long tiers green; Unity not run; not played.** Design 51 §8 has the verification.

| Unit | What | Done when | Goldens |
|---|---|---|---|
| **TM0** | Interview, four research lanes, design 51, this plan | written and committed | none |
