...
| **CV6b** the art | The Blender sandbag set (straight, corner, end, T) under `Assets/Art/Custom/Cover/`, replacing the placeholders. First: the Synty inventory run over Battle Royale and the Meadow pack. | §7a | Unity tiers; the owner's eye |
