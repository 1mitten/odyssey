...
**Read next:**
- `docs/design/58-prisoners.md`, the design these answers decide;
...
They are in `docs/design/58-prisoners.md` §8–§10, with the days-to-recruit table the recruitment numbers imply.
