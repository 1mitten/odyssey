# ADR 0004 — Pixel-art icons: author at 64 px, point-filtered, displayed at 32 and 64
...
- **Related:** `docs/adr/0001-ui-framework.md`, `docs/design/11-icon-library.md`, `docs/design/09-ui-and-input.md` §§4.3, 4.4, 5, 7, 9 D4
