...
namespace Odyssey.Presentation.Rendering
{
    ...
    public sealed class CombatClipEntry
    {
        ...
        /// the take-off's file (design 43 §7). Empty for every row whose clip is its file's.
        /// </summary>
    ...
    public static class ModuleIds
    {
        ...
        /// <summary>
        /// Jumping a one-cell stream (design 43 §7): the take-off, <c>A_Jump_Walking_Masc</c> and
