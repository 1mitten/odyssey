...
namespace Odyssey.Presentation.Bootstrap
{
    ...
    public sealed class OdysseyBootstrap : MonoBehaviour
    {
        ...
        {
            // A planet site (design 57), from the World screen on a new game or from the header on
            ...
            // A mountainous site is 24 layers deep (design 57 §5) — decided here, with the rest of
            ...
            // With a site, the board's seed is the tile's of the world (design 57 §8): the same
