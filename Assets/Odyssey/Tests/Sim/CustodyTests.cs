...
{
    /// <summary>
    /// Custody and the one owner of sides (design 58 §4). A pawn's kind never changes; custody is
    /// the override, and <see cref="Allegiance"/> turns it into every answer about sides. These
    /// tests hold one row each of design 58 §4b's consumer table, the save and the hash, and the
    ...
    public class CustodyTests
    {
        ...
        /// <summary>
        /// <b>Nothing but the loader writes a pawn's kind</b> (design 58 §4a). A recruit is a
