...
{
    /// <summary>
    /// Jumping a one-cell stream (design 43): the rule, its price, and where it is not allowed.
    ///
    ...
    public class JumpTests
    {
        ...
        /// <summary>
        /// The ownership argument of design 43 §5, proved rather than argued: a jump link is owned by
    ...
    /// <summary>
    /// A colonist and her jump, through the game's own composition root (design 43 §6): the
