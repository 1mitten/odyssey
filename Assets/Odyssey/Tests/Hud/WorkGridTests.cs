...
namespace Odyssey.Tests.Hud
{
    ...
    public class WorkGridTests
    {
        ...
        public void TheGridDrawsTheDesignsTwentyTwoAndNotTheSimulationsFive()
        {
            ...
            // Nine since the smelter (design 62 §9): Crafting's column went live with Work_Crafting.
            Assert.That(WorkCatalogue.LiveCount, Is.EqualTo(9),
                "Construction, Chopping, Mining, Hauling, Growing, Rescue, Doctor, Cooking and Crafting are what WorkTypes.xml runs.");
