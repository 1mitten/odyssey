...
namespace Odyssey.Tests.Hud
{
    ...
    public class HudStyleSheetTests
    {
        ...
        static readonly (string Selector, string Property, Func<HudColour> Token, string Name)[] Colours =
        {
            ...
            // The draw's machine (design 41 §6.5): the white face, the ink in it, the jackpot's gold,
            // the tease's amber bars, and the Creation switch's lit segment.
            (".draw__window", "background-color", () => HudTheme.MachineFace, "machine face"),
            (".draw__item", "color", () => HudTheme.MachineInk, "machine ink"),
            (".setup__detail--machine.setup__detail--jackpot", "border-color", () => HudTheme.MachineStar, "machine star"),
            (".draw__verdict--jackpot", "background-color", () => HudTheme.MachineStar, "machine star"),
            (".draw__verdict--jackpot", "color", () => HudTheme.MachineInk, "machine ink"),
            (".draw__bar", "background-color", () => HudTheme.Warn, "warn"),
            (".draw__segment--on", "background-color", () => HudTheme.Accent, "accent"),
            (".draw__segment--on .draw__segment-label", "color", () => HudTheme.OnAccent, "on-accent ink"),
            (".draw__action--pull", "background-color", () => HudTheme.Accent, "accent"),
            (".draw__action--stop", "background-color", () => HudTheme.Warn, "warn"),
        ...
        static readonly (string Selector, string Property, Func<float> Token, string Name)[] Lengths =
        {
            ...
            (".skill--reel", "height", () => HudLayout.DrawSkillRow, "a Gamble skill row"),
            (".draw__flame", "width", () => HudLayout.FlameWidth, "the passion flame"),
            (".draw__flame", "height", () => HudLayout.FlameHeight, "the passion flame"),
            (".draw__flame", "margin-left", () => HudLayout.FlameGap, "window to flame"),
            (".draw__identity", "height", () => HudLayout.IdentityHeight, "the identity row"),
            (".draw__window--name", "margin-left", () => HudLayout.IdentityGap, "portrait to name"),
            (".draw__pace", "margin-left", () => HudLayout.IdentityGap, "name to pace"),
            (".draw__verdict", "height", () => HudLayout.VerdictHeight, "the verdict tag"),
            (".draw__window--trait", "margin-right", () => HudLayout.TraitWindowGap, "between trait windows"),
            (".draw__action", "min-width", () => HudLayout.ActionButtonMinWidth, "the action button"),
            (".draw__action", "height", () => HudLayout.ActionButtonHeight, "the action button"),
            (".draw__bulb", "width", () => HudLayout.Bulb, "a bulb"),
            (".draw__bulb", "height", () => HudLayout.Bulb, "a bulb"),
            (".draw__rail", "left", () => HudLayout.BulbInsetX, "a rail's side inset"),
            (".draw__rail--top", "top", () => HudLayout.BulbInsetY, "the top rail's inset"),
            (".draw__rail--bottom", "bottom", () => HudLayout.BulbInsetY, "the bottom rail's inset"),
            (".setup__detail--machine", "padding-top", () => HudLayout.MachinePadY, "the machine's padding"),
            (".setup__detail--machine", "padding-left", () => HudLayout.MachinePadX, "the machine's padding"),
