...
namespace Odyssey.Tests.Hud
{
    ...
    public class HudStyleSheetTests
    {
        ...
        static readonly (string Selector, string Property, Func<float> Token, string Name)[] Lengths =
        {
            ...
            (".inspect__toggle", "width", () => HudLayout.InspectToggleWidth, "a header toggle's column"),
            (".inspect__toggle", "margin-left", () => HudLayout.InspectActionGap, "between the header's columns"),
            (".inspect__tile", "width", () => HudLayout.InspectToggleTile, "a header toggle's tile"),
            (".inspect__tile", "height", () => HudLayout.InspectToggleTile, "a header toggle's tile"),
            (".inspect__togglelabel", "margin-top", () => HudLayout.InspectToggleGap, "tile to label"),
            (".inspect__togglelabel", "height", () => HudLayout.InspectToggleLabel, "a toggle's label line"),
            (".inspect__cap", "right", () => HudLayout.InspectCapInset, "the hotkey cap's inset"),
            (".inspect__cap", "bottom", () => HudLayout.InspectCapInset, "the hotkey cap's inset"),
            (".inspect__stack", "margin-left", () => HudLayout.InspectActionGap + HudLayout.InspectStackMargin,
                "the Close/Info stack's gap and margin"),
            (".inspect__close", "width", () => HudLayout.InspectStackButton, "Close"),
            (".inspect__close", "height", () => HudLayout.InspectStackButton, "Close"),
            (".inspect__info", "width", () => HudLayout.InspectStackButton, "Info"),
            (".inspect__info", "height", () => HudLayout.InspectStackButton, "Info"),
            ...
            // The Story block and the three-column page it made (design 68 §12, mockups 25a-25c).
            (".setup__detail", "width", () => HudLayout.SetupSkillsWidth, "the skills column"),
            (".setup__detail", "margin-left", () => HudLayout.SetupColumnGap, "between the page's columns"),
            (".story", "margin-left", () => HudLayout.SetupColumnGap, "between the page's columns"),
            (".setup--compact .colonists", "width", () => HudLayout.SetupPeopleColumnCompact, "the compact candidate column"),
            (".setup--compact .setup__detail", "width", () => HudLayout.SetupSkillsWidthCompact, "the compact skills column"),
            (".setup--compact .setup__detail", "margin-left", () => HudLayout.SetupColumnGapCompact, "compact column gap"),
            (".setup--compact .story", "margin-left", () => HudLayout.SetupColumnGapCompact, "compact column gap"),
            (".setup--compact .skills--setup", "max-width", () => HudLayout.SetupSkillsWidthCompact, "compact skills grid"),
            (".setup--compact .skill--setup", "width", () => HudLayout.SetupSkillRowWidthCompact, "a compact skill line"),
            (".story__card--after", "margin-left", () => HudLayout.StoryCardGap, "between story cards"),
            (".story .story__card", "padding", () => HudLayout.StoryCardPad, "a story card's padding"),
            (".story__portrait", "width", () => HudLayout.StoryPortrait, "a storyteller's portrait"),
            (".story__portrait", "height", () => HudLayout.StoryPortrait, "a storyteller's portrait"),
            (".story__blurb", "height", () => HudLayout.StoryBlurbHeight, "a card's blurb"),
            (".story__blurb-compact", "height", () => HudLayout.StoryBlurbHeightCompact, "the compact blurb"),
            (".story__strip", "height", () => HudLayout.StoryStripHeight, "a rhythm strip"),
            (".setup--compact .story__strip", "height", () => HudLayout.StoryStripHeightCompact, "a compact rhythm strip"),
            (".story__heading--gap", "margin-top", () => HudLayout.StorySectionGap, "above Difficulty"),
            (".setup--compact .story__heading--gap", "margin-top", () => HudLayout.StorySectionGapCompact, "above Difficulty, compact"),
            (".story__rung", "height", () => HudLayout.StoryLadderHeight, "a difficulty rung"),
            (".setup--compact .story__rung", "height", () => HudLayout.StoryLadderHeightCompact, "a compact rung"),
            (".story__custom", "margin-top", () => HudLayout.StoryCustomGap, "ladder to Custom"),
            (".story__lever", "height", () => HudLayout.StoryCustomRow, "a Custom lever row"),
            (".setup--compact .story__lever", "height", () => HudLayout.StoryCustomRowCompact, "a compact lever row"),
            (".story__lever--left", "padding-right", () => HudLayout.StoryCustomColumnGap / 2f, "half the lever gap"),
            (".story__lever--right", "padding-left", () => HudLayout.StoryCustomColumnGap / 2f, "half the lever gap"),
            (".story__lever .story__fader", "width", () => HudLayout.StoryCustomSlider, "a Custom slider"),
            (".story__figure", "width", () => HudLayout.StoryCustomFigure, "a Custom figure"),
            (".sw__custom", "padding-left", () => HudLayout.SettingsCustomIndent, "Custom's indent in Settings"),
            (".clock__tension", "width", () => HudLayout.ClockGauge, "the tension gauge"),
            (".clock__tension", "height", () => HudLayout.ClockGauge, "the tension gauge"),
            (".clock__tension", "margin-left", () => HudLayout.ClockGaugeGap, "weather to gauge"),
