...
<<<<<<< HEAD
            Assert.That(DebugDirector.SpawnRows.Length, Is.EqualTo(21),
                "colonist, arm-all, hurt, heal, kill, bandit, three bandits, pistol bandit, three animals, " +
                "five weapons, four resources and the medical supplies");
=======
            Assert.That(DebugDirector.SpawnRows.Length, Is.EqualTo(23),
                "colonist, arm-all, hurt, heal, kill, bandit, three bandits, pistol bandit, imprison, free, break out, " +
                "two animals, five weapons, four resources and the medical supplies");
