...
namespace Odyssey.Tests.Hud
{
    ...
    public class CombatDirectorsTests
    {
        ...
        public void EverySpawnRowIsNamedInTheRegistryAndSaysWhatItDoes()
        {
            ...
            Assert.That(DebugDirector.SpawnRows.Length, Is.EqualTo(27),
                "colonist, arm-all, hurt, heal, kill, bandit, three bandits, pistol bandit, four butchers, the trader, three animals, " +
                "five weapons, four resources, gold and the medical supplies");
