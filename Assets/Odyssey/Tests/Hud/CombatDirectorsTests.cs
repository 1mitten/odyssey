...
namespace Odyssey.Tests.Hud
{
    ...
    public class CombatDirectorsTests
    {
        ...
        public void EverySpawnRowIsNamedInTheRegistryAndSaysWhatItDoes()
        {
            ...
            Assert.That(DebugDirector.SpawnRows.Length, Is.EqualTo(34),
                "colonist, arm-all, hurt, heal, kill, bandit, three bandits, pistol bandit, four butchers, twelve animals, " +
