...
{
    /// <summary>
    /// The names a colonist's state of mind is published under (design 51 §4d), spelled on this
    ...
    public static class MindAspectNames
    {
        ...
        /// <summary>Trait slot keys (design 51 §4d): the handle, then each effect.</summary>
