...
namespace Odyssey.Hud
{
    ...
    public sealed class DebugDirector
    {
        ...
        public static readonly SpawnRow[] SpawnRows =
        {
            ...
            new SpawnRow(SpawnGunmanKey, "Adds a hostile bandit near the camera, holding a sidearm. It shoots whoever it can see",
            ...
            Weapon(SpawnArcBladeKey, "Adds an arc blade near the camera. The best thing a colonist can hold",
                ItemHandle.ArcBlade),
            Weapon(SpawnPistolKey, "Adds a sidearm near the camera. It shoots, and is deadly close and poor far off",
                ItemHandle.Pistol),
