...
namespace Odyssey.Hud
{
    ...
    public static class BuildShapes
    {
        ...
        /// <see cref="BuildingHandle"/>: nothing, wall, floor, deck plate, ladder, bed, door, shelf.
        /// </summary>
        public static readonly int[] Cells = { 1, 1, 1, 1, 1, 2, 1, 1 };
        ...
        /// </summary>
        public static readonly bool[] Rotates = { false, false, false, false, true, true, true, true };
