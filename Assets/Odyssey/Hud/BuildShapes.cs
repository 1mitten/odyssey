...
namespace Odyssey.Hud
{
    ...
    public static class BuildShapes
    {
        ...
        /// shelf, campfire, conduit, generator, heater, galley, sandbags, stair, smelter.
        /// </summary>
        public static readonly int[] Cells = { 1, 1, 1, 1, 1, 2, 1, 1, 1, 1, 2, 1, 1, 1, 2, 1 };
        ...
        /// </summary>
        public static readonly bool[] Rotates = { false, false, false, false, true, true, true, true, false, false, true, true, true, false, true, true };
