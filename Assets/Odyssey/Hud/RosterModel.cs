...
namespace Odyssey.Hud
{
    ...
    public struct RosterCard
    {
        ...
        /// <summary>The <see cref="MoodBand"/> the simulation published for her (design 51 §5a).</summary>
        public int MoodBand;
    ...
    /// <summary>
    /// The mood band's words, read from the band <b>the simulation publishes</b> (design 51 §5a).
    ///
