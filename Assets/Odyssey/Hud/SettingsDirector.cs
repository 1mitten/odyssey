...
namespace Odyssey.Hud
{
    ...
    public sealed class SettingsDirector
    {
        ...
        public EscapeAction Escape(bool toolArmed, bool paletteOpen, bool menuOpen, bool workOpen,
            ...
            Escape(toolArmed, paletteOpen, menuOpen, workOpen, almanacOpen, inventoryOpen: false,
                researchOpen: false, startScreen);

        /// <summary>
        /// The same rule with the Inventory and Research tabs in it (designs 35 and 34). Both dock
        /// in the Work tab's corner and the shell closes each when another opens, so they unwind
        /// at its rung and their order among themselves is not observable.
        /// </summary>
        public EscapeAction Escape(bool toolArmed, bool paletteOpen, bool menuOpen, bool workOpen,
            bool almanacOpen, bool inventoryOpen, bool researchOpen, MenuScreen? startScreen)
        {
