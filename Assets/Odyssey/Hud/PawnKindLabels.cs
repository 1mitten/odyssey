...
namespace Odyssey.Hud
{
    ...
    /// hog 1, the duct rat 2, the bandit 3, the culvert frog 4, appended and never inserted. A kind past the table
    ...
    public static class PawnKindLabels
    {
        ...
        /// </summary>
        public const int ColonistKind = 0, MiddenHogKind = 1, DuctRatKind = 2, Bandit = 3, CulvertFrogKind = 4;
