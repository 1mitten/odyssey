...
namespace Odyssey.Hud
{
    ...
    public static class CombatFeedbackModel
    {
        ...
        /// bars on her pane speak one scale of colours.
        /// </summary>
        public static HudColour HealthBarColour(int hpMilli, int hpMaxMilli)
        {
            if (hpMaxMilli <= 0) return HudTheme.Bad;
            long perMille = (long)hpMilli * 1000 / hpMaxMilli;
            return perMille >= 600 ? HudTheme.Good : perMille >= 400 ? HudTheme.Warn : HudTheme.Bad;
        }
