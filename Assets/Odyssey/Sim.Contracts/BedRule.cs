...
{
    /// <summary>
    /// Who a bed is for (design 60 §5). A colony bed is the default; a prison bed is one the player
    ...
    /// <summary>
    /// Which pool of beds a pawn sleeps from (design 60 §5a). <see cref="None"/> is everybody who
    ...
    /// <summary>
    /// <b>The one rule for who may use and own a bed</b> (design 60 §5a).
    ///
