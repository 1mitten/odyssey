...
namespace Odyssey.Sim
{
    ...
    public sealed class SnapshotWriter
    {
        ...
        /// <summary>Publish one trader and its negotiation (design 65). See <see cref="TradeView"/>.</summary>
        public void AddTrade(in TradeView view) => _target.AddTrade(view);

        /// <summary>Publish one row of a ready ledger (design 65). See <see cref="TradeRowView"/>.</summary>
