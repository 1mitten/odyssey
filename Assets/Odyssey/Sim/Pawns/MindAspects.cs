...
{
    /// <summary>
    /// The names a colonist's state of mind is published under (design 51 §4d): the band and the
    ...
    public static class MindAspects
    {
        ...
        /// <summary>
        /// Her traits by slot (design 51 §4d): <c>odyssey.pawn.trait.0</c> to <c>.2</c> carry the
