...
{
    /// <summary>
    /// Everything the colony remembers about a pawn it holds, held, or means to take (design 60
    ...
    public sealed class PrisonRecord
    {
        ...
        /// <summary>Laid in a prison bed, so she wears the jumpsuit until she is free again (design 60 §11d).</summary>
        public bool Dressed;

        /// <summary>A colonist when she was taken (design 60 §10): released, she goes back to the colony.</summary>
        public bool Arrested;

        /// <summary>A downed pawn the player has asked a warden to bring in (design 60 §7).</summary>
        ...
        /// <summary>How far talked round, 0 to 1,000,000 (design 60 §8).</summary>
