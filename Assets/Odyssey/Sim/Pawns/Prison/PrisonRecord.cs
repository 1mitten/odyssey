...
{
    /// <summary>
    /// Everything the colony remembers about a pawn it holds, held, or means to take (design 58
    ...
    public sealed class PrisonRecord
    {
        ...
        /// <summary>Laid in a prison bed, so she wears the jumpsuit until she is free again (design 58 §11d).</summary>
        public bool Dressed;

        /// <summary>A colonist when she was taken (design 58 §10): released, she goes back to the colony.</summary>
        public bool Arrested;

        /// <summary>A downed pawn the player has asked a warden to bring in (design 58 §7).</summary>
        ...
        /// <summary>How far talked round, 0 to 1,000,000 (design 58 §8).</summary>
