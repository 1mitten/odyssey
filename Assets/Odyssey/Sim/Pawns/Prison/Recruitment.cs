...
{
    /// <summary>
    /// Why a prisoner is being talked round slowly, as bits (design 60 §8). Published as one number
    ...
    /// <summary>
    /// <b>The one owner of how fast a prisoner is talked round</b> (design 60 §8). The chat driver
    ...
    public static class Recruitment
    {
        ...
        /// <summary>
        /// She joins the colony (design 60 §8): free, her side the colony's for good, her kind
