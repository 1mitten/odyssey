...
{
    /// <summary>
    /// Named random purposes for the prison (design 60 §6, §9, §10), each draw its own stream:
    ...
    {
        /// <summary>The hourly escape roll (design 60 §9b).</summary>
        public const uint Escape = 0xC6E0_0BF3;

        /// <summary>A badly hurt raider's one chance to yield (design 60 §10).</summary>
        public const uint Surrender = 0xD5A7_9147;

        /// <summary>Whether a colonist being arrested resists (design 60 §10).</summary>
        public const uint ArrestResist = 0x06CA_6351;

        /// <summary>Which cell of her room a prisoner walks to next (design 60 §6).</summary>
