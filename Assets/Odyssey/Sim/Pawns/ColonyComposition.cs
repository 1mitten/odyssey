    ...
    public static class ColonyComposition
    {
            ...
            Worldgen.ClimateDef? climate = null, int wetPerMille = 1000)
        {
            ...
            builder
                ...
                // The chambers nobody has opened (design 62 §6), hashed only while one is: a
                // board with no caverns hashes as it did before the fog.
                .AddHashable(pawns.Cells.Unseen)
