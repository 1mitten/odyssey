...
{
    /// <summary>
    /// The mental-break taxonomy (design 51 §5c): which break a colonist falls into, and what each
    ...
    {
        /// <summary>
        /// Which break, from the tier she is under (design 51 §5c): a weighted pick by
        ...
        /// every break falls back to; anything else is ended as a failure (design 51 §5c).
        /// </summary>
