...
{
    /// <summary>
    /// Each colonist's traits (design 51 §3), as one save section on exactly the terms of
    ...
    /// in (design 51 §5c), written as nought until the break taxonomy fills it; it is here from the
