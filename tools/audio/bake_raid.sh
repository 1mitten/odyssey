...
# docs/design/55-raids.md §7): played when a raid ARRIVES at the edge of the board. An alert, 2D,
...
# that is too long for an alert is a question for a person at the keyboard (design 55 §7), not
