...
- **Phase 3 (design): complete 2026-09-15, awaiting owner approval.** `docs/design/` 00, 01, 02, 03, 04, 05, 06, 07, 08; ADRs 0001, 0002, 0005; and the execution plan `docs/plans/vertical-slice.md` (32 units, M0→M3). **The Phase 3 → Phase 4 hard stop is in force: no gameplay code until the owner approves.**
