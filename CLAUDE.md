...
- **Fast tier** (`scripts/test-fast.sh`, ~30 s, no Unity): **793 Sim + 480 Hud**; Long tier **23**
  (2026-09-20, on `claude/skills-review` — #139 with #119 merged up and the review's own fixes).
  Higher than `main`'s 753 + 449 + 21 because this measurement sits on PR #119 and therefore counts
