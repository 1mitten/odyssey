...
- **Fast tier** (`scripts/test-fast.sh`, ~30 s, no Unity): **791 Sim + 475 Hud**; Long tier **23**
  (2026-09-20, dotnet 8.0.131 in the remote container). Higher than `main`'s 753 + 449 + 21 because
  this measurement is from `claude/skills-system-design-k3ufis`, which sits on PR #119 and therefore
  counts growing's tests as well as the skills ones.
