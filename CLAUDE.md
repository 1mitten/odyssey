...
| **Prisoners: prison beds and cells, custody, `Allegiance`, `BedRules`, recruitment, escape** | `docs/design/58-prisoners.md` |
| **Factions: goodwill, relations, `Allegiance.AreHostile`, the collector, the Orc Army, the world list, the trade line's contract** | `docs/design/61-factions.md` |
