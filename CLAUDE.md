...
- **Unity tier** (`scripts/unity.sh test editmode`, authoritative), last run 2026-09-21 on
  `claude/huge-map` **after merging main, the decoration measurement and the surround cut**:
  EditMode **2,320 total, 2,297 passed, 0 failed**; PlayMode **94 total, 89 passed, 0 failed**. The
