...
- **Fast tier** (`scripts/test-fast.sh`, ~35 s, no Unity): **878 Sim + 552 Hud** (2026-09-20, the paged Work tab branch after the owner's second look); Long tier **21**.
...
- **Unity tier** (`scripts/unity.sh test editmode`, authoritative), last run 2026-09-20 on the
  paged Work tab branch after the owner's second look: EditMode **2,197 total, 2,179 passed,
  0 failed**; PlayMode **88 total, 83 passed, 0 failed**. The remainder are `[Explicit]` or ignored.
  The run before it, the same branch before that look, was EditMode 2,188 / 2,170 and PlayMode
  88 / 83.
