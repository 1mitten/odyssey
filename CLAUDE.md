...
| **The storyteller: the pacer, the strength budget, tension, difficulty** | `docs/design/59-storyteller.md` |
...
- **The storyteller is built but unplayed** (design 59 §13, `claude/sweet-cerf-wzfxgs`); on `main` nothing fires an event but the debug menu (owner's call, 2026-09-20). The
