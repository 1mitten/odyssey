...
- **Fast tier** (`scripts/test-fast.sh`, ~14 s, no Unity): **608 Sim + 332 Hud**; Long tier **20**.
  Unity tier on 2026-09-17, after U40: EditMode **1414 total, 1403 passed, 0 failed**; PlayMode
  **60 total, 57 passed, 0 failed** (the rest are pre-existing `[Explicit]` or ignored rows).
